...
<v-row>
  <input id="search-box" placeholder="add option" type="text" class="search-box" name="q" style="margin-left:0px" v-on:keyup.enter="onEnter($event, $event.target.value), $event.target.value = ''"/>
