          ...
          <v-row no-gutters>
           ...
           <v-expansion-panel-text v-bind:class='{ "error": error_at == index }'>
            <div id="app" v-cloak style="max-width:900px">
              <dropdown-select v-model:is_required="item.is_required" v-model:prop="item.type" v-model:selectionsProp="item.options"></dropdown-select>
            </div>
